...
const TemplateSatellite = ({ DOMAIN_URL, julianEphemerisDate, zoomToObject, target, innerLabels, moonLabels, orbitColor }) => {
	console.log("TemplateSatellite()");
...
export default TemplateSatellite;