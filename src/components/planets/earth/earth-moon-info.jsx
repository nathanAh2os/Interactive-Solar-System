...
const EarthMoonInfo = ({ infoStore, tempUnit, pressureUnit, lengthUnit, orbitalUnit }) => {
	console.log("EarthMoonInfo()");
...
/* 		let numberedInputs = document.getElementsByClassName("leva-c-ghmOOI-gsXdEb-levaType-number");
	...
	return <LevaPanel store={infoStore} flat titleBar={{title: "Moon Info"}} />;
};

export default EarthMoonInfo;