...
const Eris = ({ DOMAIN_URL, julianEphemerisDate, zoomToObject, target, innerLabels, moonLabels, orbitColor }) => {
	console.log("Eris()");
	...
	if (innerLabels === true) {
		labelJSX = <div className="satellite-label" onClick={() => zoomToObject("eris", zoomLevel, x, y, z)}>Eris</div>
	} else {
		labelJSX = null;
	}
