...
const Haumea = ({ DOMAIN_URL, julianEphemerisDate, zoomToObject, target, innerLabels, moonLabels, orbitColor }) => {
	console.log("Haumea()");
	...
	if (innerLabels === true) {
		labelJSX = <div className="satellite-label" onClick={() => zoomToObject("haumea", zoomLevel, x, y, z)}>Haumea</div>
	} else {
		labelJSX = null;
	}
